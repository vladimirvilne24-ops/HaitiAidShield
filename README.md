...
- **Trust Triangle Mechanism:** Requires $N$-of-$M$ cryptographic signatures (e.g., International Donor, Local NGO, and Independent Auditor) before any fund release.
- **Immutable Audit Trail:** All aid requests and disbursements are permanently logged on-chain and are globally auditable in real-time.
...
## 📂 Project Structure
- `/Contracts`: Core logic `HaitiAidShield.sol`
- `/bin`: Compiled artifacts (ABI & Bytecode)
- `/Docs`: Technical Manual & Architecture Diagrams
- `README.md`: This project abstract
